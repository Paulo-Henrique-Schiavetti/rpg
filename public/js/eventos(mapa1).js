...
var posicionareventos = setTimeout(function(){
    ...
    document.getElementById('eventoi1').style = 'bottom:'+(eventoi1x*1.4)+'%; right:'+eventoi1y+'%;';
    document.getElementById('eventoi1').style.zIndex = 99-eventoi1x;
    document.getElementById('eventoi2').style = 'bottom:'+(eventoi2x*1.4)+'%; right:'+eventoi2y+'%;';
...
function eventoi1() {
    if(eventoi1ativo==false){
        if (mirax == eventoi1x && miray == eventoi1y) {
...
function eventoi2() {
    if(eventoi2ativo==false){
        if (mirax == eventoi2x && miray == eventoi2y) {
